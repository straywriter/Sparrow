  ...
  private:
    ...
    struct RefCounted
    {
                                      ...
                                      size_t *newCapacity)
        {
            ...
            const size_t allocNewCapacity = goodMallocSize(getDataOffset() + (*newCapacity + 1) * sizeof(Char));
...
template <class Char> inline void fbstring_core<Char>::copySmall(const fbstring_core &rhs)
{
...
template <class Char> FOLLY_NOINLINE inline void fbstring_core<Char>::copyMedium(const fbstring_core &rhs)
{
...
template <class Char> FOLLY_NOINLINE inline void fbstring_core<Char>::copyLarge(const fbstring_core &rhs)
{
...
template <class Char> inline void fbstring_core<Char>::initSmall(const Char *const data, const size_t size)
{
...
template <class Char>
FOLLY_NOINLINE inline void fbstring_core<Char>::initMedium(const Char *const data, const size_t size)
{
...
template <class Char>
FOLLY_NOINLINE inline void fbstring_core<Char>::initLarge(const Char *const data, const size_t size)
{
...
template <class Char> FOLLY_NOINLINE inline void fbstring_core<Char>::unshare(size_t minCapacity)
{
...
template <class Char> FOLLY_NOINLINE inline void fbstring_core<Char>::reserveLarge(size_t minCapacity)
{
    assert(category() == Category::isLarge);
    if (RefCounted::refs(ml_.data_) > 1)
    { // Ensure unique
...
template <class Char> FOLLY_NOINLINE inline void fbstring_core<Char>::reserveMedium(const size_t minCapacity)
{
    assert(category() == Category::isMedium);
...
template <class Char>
FOLLY_NOINLINE inline void fbstring_core<Char>::reserveSmall(size_t minCapacity, const bool disableSSO)
{
    assert(category() == Category::isSmall);
...
template <class Char> inline void fbstring_core<Char>::shrinkSmall(const size_t delta)
{
    // Check for underflow
...
template <class Char> inline void fbstring_core<Char>::shrinkMedium(const size_t delta)
{
...
template <class Char> inline void fbstring_core<Char>::shrinkLarge(const size_t delta)
{
    assert(ml_.size_ >= delta);
...
class basic_fbstring
{
    ...
    template <typename Ex, typename... Args> FOLLY_ALWAYS_INLINE static void enforce(bool condition, Args &&...args)
    {
        if (!condition)
        {
  ...
  public:
    ...
    FOLLY_NOINLINE
    /* implicit */ basic_fbstring(const value_type *s, const A & /*a*/ = A()) : store_(s, traitsLength(s))
    {
    }
    ...
    basic_fbstring(value_type *s, size_type n, size_type c, AcquireMallocatedString a) : store_(s, n, c, a)
    {
    }
    ...
    template <typename A2> basic_fbstring &operator=(const std::basic_string<E, T, A2> &rhs)
    {
    ...
    template <class InputIterator> basic_fbstring &append(InputIterator first, InputIterator last)
    {
    ...
    template <class ItOrLength, class ItOrChar> basic_fbstring &assign(ItOrLength first_or_n, ItOrChar last_or_c)
    {
  ...
  private:
    ...
    template <class InputIter> iterator insertImplDiscr(const_iterator i, InputIter b, InputIter e, std::false_type);
  ...
  private:
    basic_fbstring &replaceImplDiscr(iterator i1, iterator i2, const value_type *s, size_type n,
                                     std::integral_constant<int, 2>);

    basic_fbstring &replaceImplDiscr(iterator i1, iterator i2, size_type n2, value_type c,
                                     std::integral_constant<int, 1>);

    template <class InputIter>
    basic_fbstring &replaceImplDiscr(iterator i1, iterator i2, InputIter b, InputIter e,
...
basic_fbstring& Append(value_type* str);
basic_fbstring& Append(value_type* str,uint32_t count);
basic_fbstring& Append(basic_fbstring&& str);
basic_fbstring& Append(const basic_fbstring& str);
basic_fbstring& AppendChar(value_type c);
// basic_fbstring& AppendFormat();
basic_fbstring& AppendInt(int intValue);
basic_fbstring& AppendDouble();
basic_fbstring& AppendFloat();
...
FOLLY_NOINLINE inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::traitsLength(
    const value_type *s)
{
    return s ? traits_type::length(s)
             : (throw_exception<std::logic_error>("basic_fbstring: null pointer initializer not valid"), 0);
}

template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::operator=(const basic_fbstring &lhs)
{
    Invariant checker(*this);
...
// Move assignment
template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::operator=(basic_fbstring &&goner) noexcept
{
...
template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::append(const basic_fbstring &str, const size_type pos,
                                                                      size_type n)
{
...
template <typename E, class T, class A, class S>
FOLLY_NOINLINE inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::append(const value_type *s, size_type n)
{
    Invariant checker(*this);
...
template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::assign(const basic_fbstring &str, const size_type pos,
                                                                      size_type n)
{
    const size_type sz = str.size();
    enforce<std::out_of_range>(pos <= sz, "");
...
template <typename E, class T, class A, class S>
FOLLY_NOINLINE inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::assign(const value_type *s,
                                                                                     const size_type n)
{
    Invariant checker(*this);
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::istream_type &basic_fbstring<E, T, A, S>::getlineImpl(istream_type &is,
                                                                                                  value_type delim)
{
    Invariant checker(*this);
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::find(const value_type *needle,
                                                                                       const size_type pos,
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::iterator basic_fbstring<E, T, A, S>::insertImplDiscr(const_iterator i,
                                                                                                 size_type n,
                                                                                                 value_type c,
                                                                                                 std::true_type)
{
...
template <typename E, class T, class A, class S>
template <class FwdIterator>
inline typename basic_fbstring<E, T, A, S>::iterator basic_fbstring<E, T, A, S>::insertImpl(const_iterator i,
                                                                                            FwdIterator s1,
                                                                                            FwdIterator s2,
...
template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::replaceImplDiscr(iterator i1, iterator i2,
...
template <typename E, class T, class A, class S>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::replaceImplDiscr(iterator i1, iterator i2, size_type n2,
                                                                                value_type c,
                                                                                std::integral_constant<int, 1>)
{
...
template <typename E, class T, class A, class S>
template <class InputIter>
inline basic_fbstring<E, T, A, S> &basic_fbstring<E, T, A, S>::replaceImplDiscr(iterator i1, iterator i2, InputIter b,
                                                                                InputIter e,
                                                                                std::integral_constant<int, 0>)
{
...
template <typename E, class T, class A, class S>
template <class FwdIterator>
inline bool basic_fbstring<E, T, A, S>::replaceAliased(iterator i1, iterator i2, FwdIterator s1, FwdIterator s2,
                                                       std::true_type)
{
    std::less_equal<const value_type *> le{};
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::rfind(const value_type *s,
                                                                                        size_type pos,
                                                                                        size_type n) const
{
    if (n > length())
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::find_first_of(const value_type *s,
                                                                                                size_type pos,
                                                                                                size_type n) const
{
    if (pos > length() || n == 0)
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::find_last_of(const value_type *s,
                                                                                               size_type pos,
                                                                                               size_type n) const
{
    if (!empty() && n > 0)
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::find_first_not_of(const value_type *s,
                                                                                                    size_type pos,
                                                                                                    size_type n) const
{
    if (pos < length())
...
template <typename E, class T, class A, class S>
inline typename basic_fbstring<E, T, A, S>::size_type basic_fbstring<E, T, A, S>::find_last_not_of(const value_type *s,
                                                                                                   size_type pos,
                                                                                                   size_type n) const
{
    if (!this->empty())
...
template <typename E, class T, class A, class S>
inline bool operator<(const basic_fbstring<E, T, A, S> &lhs, const typename basic_fbstring<E, T, A, S>::value_type *rhs)
{
    return lhs.compare(rhs) < 0;
}

template <typename E, class T, class A, class S>
inline bool operator<(const typename basic_fbstring<E, T, A, S>::value_type *lhs, const basic_fbstring<E, T, A, S> &rhs)
{
...
inline bool operator==(const basic_fbstring<E, T, A, S> &lhs, const std::basic_string<E, T, A2> &rhs)
{
    return lhs.compare(0, lhs.size(), rhs.data(), rhs.size()) == 0;
}

template <typename E, class T, class A, class S, class A2>
inline bool operator==(const std::basic_string<E, T, A2> &lhs, const basic_fbstring<E, T, A, S> &rhs)
{
    return rhs == lhs;
}
...
template <class T, class R, class A, class S> FOLLY_ASSUME_RELOCATABLE(basic_fbstring<T, R, A, S>);
