...
public:
  ...
  // Move constructor
  TString(TString &&goner) noexcept : store_(std::move(goner.store_)) {}

  // This is defined for compatibility with std::string
  template <typename A2>
  /* implicit */ TString(const std::basic_string<CharType, TraitType, A2> &str) : store_(str.data(), str.size())
  {}
  ...
  FOLLY_NOINLINE
  TString(const value_type *s, size_type n, const Allocator & /*a*/ = Allocator()) : store_(s, n) {}
  ...
  FOLLY_NOINLINE
  TString(const value_type *b, const value_type *e, const Allocator & /*a*/ = Allocator()) : store_(b, size_type(e - b))
  {}

  // Nonstandard constructor
  TString(value_type *s, size_type n, size_type c, folly::AcquireMallocatedString a) : store_(s, n, c, a) {}
