...
template <typename T, size_t size> T Lenth(const TVector<T, size> &val);

template <typename T, size_t size> T SquaredLenth(const TVector<T, size> &val);

} // namespace Vector

} // namespace Math
#include "Math/Inline/VectorOperator.inl"