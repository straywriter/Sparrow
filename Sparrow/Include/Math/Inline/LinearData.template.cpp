...
template <typename Derived, typename T>
inline Math::LinearData<Derived, T, 2, 1, LinearDataType::Vector>::LinearData(const T &x, const T &y)
{
}
...
inline Math::LinearData<Derived, T, 3, 1, LinearDataType::Vector>::LinearData(
    LinearData<OtherDerived, OtherType, OtherSize, 1, LinearDataType::Vector> &val)
{
}
