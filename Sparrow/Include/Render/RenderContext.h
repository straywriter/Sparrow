...
class RenderContext
{
  public:
    ...
    virtual IndexBuffer *CreateIndexBuffer(void *data, uint32_t size)
    {
        return nullptr;
    }
    ...
    virtual Shader *CreateShader(EShaderType shaderType, std::string data)
    {
        return nullptr;
    }
    ...
    virtual Program *CreateProgram(Shader *vert, Shader *frag)
    {
        return nullptr;
    }

    virtual Program *DestoryProgram(Program *inputObject)
    {
        return nullptr;
    }
