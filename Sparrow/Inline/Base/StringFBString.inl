...
// template <typename CharType> inline Sparrow::TString<CharType>::TString() : folly::String<CharType>()
// {
// }

// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(const TString<CharType> &str) : folly::String<CharType>(str)
// {
// }

// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(const CharType *str) : folly::String<CharType>(str)
// {
// }

// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(TString &&str) : folly::String<CharType>(str)
// {
// }

// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(const TString &str, size_t start, size_t num)
//     : folly::String<CharType>(str, start, num)
// {
// }
// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(size_t start, size_t num) : folly::String<CharType>(start, num)
// {
// }
// template <typename CharType>
// template <typename Iterator>
// inline Sparrow::TString<CharType>::TString(Iterator begin, Iterator end) : folly::String<CharType>(begin, end)
// {
// }
// template <typename CharType>
// inline Sparrow::TString<CharType>::TString(const CharType *begin, const CharType *end)
//     : folly::String<CharType>(begin, end)
// {
// }
...
// {
//     return folly::String<CharType>::operator=(str);
// }
...
// {
//     return folly::String<CharType>::operator=(init_list);
// }
...
// template <typename CharType> inline CharType *Sparrow::TString<CharType>::Data()
// {
//     return data();
// }
...
// {
//     return folly::String<CharType>::operator[](pos);
// }
...
// {
//     return folly::String<CharType>::operator[](str_char);
// }
...
// {
//     return static_cast<Sparrow::TString<CharType>>( append(str));
// }
...
// {
//     return folly::String<CharType>::getline(in_stream, str, delim);
// }

// // template <typename CharType>
// // inline Sparrow::TString<CharType> Sparrow::TString<CharType>::operator+(const Sparrow::TString<CharType> &str)
// // {
// //     Sparrow::TString<CharType> result;
// //     result.reserve(this->size() + str.size());
// //     result.append(*this).append(str);
// //     return result;
// // }
...
//     result.Append(left_str).Append(right_str);
//     return result;
// }
